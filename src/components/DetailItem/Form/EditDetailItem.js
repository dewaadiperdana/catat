...
export class EditDetailItem extends Component {
    constructor(props) {
        super(props);
    ...
    onSimpan = async () => {
        ...
        try {
            let response = await axios.put(`${BASE_URL}api/detail-hari/${match.params.id}`, data, {
                headers: {
        ...
        return(
            <View>
                ...
                <View style={container}>
                    <Text style={centerTitle}>Edit Detail Item</Text>
